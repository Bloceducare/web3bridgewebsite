const web3 = `<!DOCTYPE html>
<html>
<head>

  <meta charset="utf-8">
  <meta http-equiv="x-ua-compatible" content="ie=edge">
  <title>Cohort X 2024 Registration</title>
...
<body style="background-color: #e9ecef;">
  ...
  <div class="preheader" style="display: none; max-width: 0; max-height: 0; overflow: hidden; font-size: 1px; line-height: 1px; color: #fff; opacity: 0;">
    Thank you for registering for Cohort X 2024
  </div>
  <!-- end preheader -->
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            ...
            We are happy to receive your application. At Web3bridge, our goal is to help you become a Web3 developer and guide you to having a proper Web3 career.
              ...
              <p>
   Web3bridge cohort X opens January 8th, 2024, however before then you will be going through a 3 stage pre-qualification phase after which you will be onboarded if you are successful at all the stages. 
              <ul> 
                <p>
                  The Pre-qualification phases are;
                </p>
                <li>
                  <b>Coding test: December 11th to 18th</b><br/>
                  It’s our interest to assess how good your Web2 skills especially Scripting, logic and problem solving

                </li>
                
                 <li>
                  <b>Interview: December 18th to 23rd</b><br/>
                 This will be a one-on-one interview session with the team, we will be interested in learning about you, your web2 experience and discuss your motivation to learn with Web3bridge

                </li>
                
                 <li>
                  <b>Pre-content:</b><br/>
                this phase, we will share web3 reading materials with you to study and we will assess your knowledge of the materials shared
...
https://twitter.com/Web3Bridge
          ...
          <p>
                 Do note that we have a very limited number to be admitted into this cohort, ensure to share with friends and families who are interested in getting started in tech.

          </p>

                <p>
               Our support team will be available to support and answer your questions on telegram and other social media platforms.
