        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td bgcolor="#ffffff" align="left" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              ...
              <p>
              We are happy to receive your application for the Zk masterclass, do note that the selection and assessment will hold from December 11th - 23rd, while the class will start on January 8,2024.
              </p>
              <p>
              Ensure to pay close attention to your email, in order not to miss the updates.
              </p>
              <p>
              Telegram: https://t.me/Web3bridge, https://t.me/ZkProject
              </p>
              <p>
              Twitter: https://twitter.com/Web3bridge, https://twitter.com/Zkproject
              </p>
              <p>
