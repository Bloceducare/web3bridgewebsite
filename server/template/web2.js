        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          ...
          <tr>
            <td bgcolor="#ffffff" align="left" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; text-align: justify;">
              ...
              <p>
                Web3bridge cohort X opens January 8 , 2024, the onboarding to the cohort starts immediately after we receive your application and we proceed to
              <ul> 
                <li>
                  Grouping every participant
                </li>
                <li>
                  Minting the token for discord onboarding which will be sent to the wallet you submitted during registration (make sure to double check and be sure the wallet submitted is an erc20 wallet, if not reach out the admin to rectify it before December 15th).
