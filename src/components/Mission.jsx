    ...
    <div className="">
      <div className="mt-20 mx-auto  flex justify-center align-center">
        <div className="font-secondary text-4xl text-base90 font-bold">
          ...
          <div className="mt-10 w-11/12 text-lg text-center font-secondary text-white60  font-medium mx-auto md:w-2/6 md:text-xl">
        ...
        {missionData.map((data, index) => {
          return (
            ...
            >
              ...
              <p className="text-center w-10/12 font-primary text-sm text-white60 dark:text-white20 md:w-3/5 ">
                {data.text}
              </p>
            </div>
          )
