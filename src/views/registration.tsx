...
const Web3View = () => {
  ...
  const config = {
    ...
    customer: {
      ...
      phone_number: "08130192777",
      name: userDetails.name,
    },
    customizations: {
      title: "Web3Bridge Cohort IX",
      description: "Web3Bridge Cohort IX",
  ...
  const onSuccessPayStack = ({ reference = "" }): void => {
    router.push(`/verify-payme&currentTrack=web3`);
  };

  // const initializePaymentPayStack = useFlutterwave(config);
