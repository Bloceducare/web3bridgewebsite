...
const CustomSection: React.FC<CustomSectionProps> = ({ heading, description, children }) => (
  ...
  <>
    ...
    <p className="text-2xl w-[600px] text-center mx-auto bg-gradient-to-b text-transparent bg-clip-text from-[hsla(40,100%,98%,1)] to-[hsla(40,100%,98%,0.67)] mb-6">{description}</p>
