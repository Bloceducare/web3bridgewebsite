...
export default function Trainings() {
  return (
    <div className="flex flex-col">
      <MaxWrapper>
        <section className="py-10 md:py-20 flex flex-col gap-5 lg:gap-10 items-center mx-auto w-full max-w-[926px]">
            ...
            <div className="w-full h-full bg-background p-6 rounded-sm grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="w-full h-full lg:max-w-[416px] flex flex-col justify-between gap-5">
                <p className="font-normal text-lg">
                  ...
                  through remote and onsite Web3 development training,
                  supporting web3 developers and startups, and lowering barriers
                  of entry into the Web3 ecosystem.
                </p>
              ...
              <div className="flex-1 w-full aspect-[1.3] gap-4 relative">
                <div className="rounded-full w-64 h-64 absolute border-2 bg-background top-0 right-5 z-10"></div>
                <div className="rounded-full w-64 h-64 absolute border-2 bg-background bottom-0 left-5"></div>
              </div>
            </div>
          </div>
        </section>
