      ...
      <div className="max-w-6xl mx-auto px-4 pt-12">
        <div className="max-w-[43rem] mx-auto">
          ...
          <p className="text-center text-gray-600 dark:text-gray-400 mb-8">
            We want our employees to feel supported and appreciated. That's why
            we offer a range of benefits designed to enhance your career and
            life.
          </p>
        </div>
          ...
          {benefitsData.map((benefit, index) => (
            <Card
              ...
              <CardContent className="flex flex-col items-center justify-center p-6">
                ...
                />
                <h3 className="mt-4 text-foreground tracking-wider text-base max-w-[9rem] font-[600] text-center dark:text-white">
                  {benefit.title}
                </h3>
              </CardContent>
            </Card>
