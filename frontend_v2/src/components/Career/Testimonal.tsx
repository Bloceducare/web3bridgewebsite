        ...
        <Card className="bg-[#FFFCF7] dark:bg-gray-800 border-0 text-black dark:text-white rounded-3xl overflow-hidden shadow-[#253A671A] dark:shadow-gray-900 shadow-lg">
          <CardContent className="p-8">
            <p className="text-base text-center leading-relaxed mb-6 text-black dark:text-gray-300">
              ...
              an organization; it's a community committed to personal growth,
              pushing boundaries, and creating impactful solutions in the Web3
              space. I feel empowered to take on challenges and continuously
              learn, and I'm proud to be part of a team that's shaping the
