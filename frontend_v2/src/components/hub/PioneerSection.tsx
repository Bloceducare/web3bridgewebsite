...
export default function PioneerSection() {
  return (
    <section className="py-24 md:py-32 w-full relative bg-muted/30">
          ...
          {[
            ...
            return (
              <motion.div
                ...
                className="p-8 rounded-lg bg-background border border-border hover:border-bridgeRed/30 transition-all group"
              >
