      ...
      <main className="w-full flex lg:flex-row flex-col-reverse lg:gap-28 gap-10 justify-between items-center py-6">
        <div className="md:flex-1 w-full flex flex-col gap-4 items-start">
          <p className="leading-relaxed text-left">
            The art’s major components include the globe, with Africa very
            pronounced, a growing and fruit-bearing fig tree, and fruits on the
            tree shown as Web3bridge logo dropping across the globe. Each
            dropping fruit represents Web3bridge Alumnis that are already in the
            global ecosystem contributing while the smaller fruits that are yet
            to form into Web3bridge logo symbolizes devs in training and those
            that are yet to come out of the program.
          </p>
        ...
        <div className="lg:w-[450px] lg:h-[450px] md:w-[350px] md:h-[350px] w-full h-[350px]">
          <Image priority src={ArtImage} alt="Art" className="w-full h-full" />
        </div>
      </main>
    </section>
  );
